...
enum OpCode {
    ...
    OP_GREATER_INTEGER_32,
    OP_LESS_INTEGER_32,
    OP_GREATER_EQUAL_INTEGER_32,
    OP_LESS_EQUAL_INTEGER_32,

    OP_I32_TO_F32,

    OP_ADD_FLOATING_32,
    OP_SUBTRACT_FLOATING_32,
    OP_MULTIPLY_FLOATING_32,
    OP_DIVIDE_FLOATING_32,
    OP_NEGATE_FLOATING_32,
    OP_COMPARE_FLOATING_32,
    OP_GREATER_FLOATING_32,
    OP_LESS_FLOATING_32,
    OP_GREATER_EQUAL_FLOATING_32,
    OP_LESS_EQUAL_FLOATING_32,
